...
from programs.PDF.user_code.problem_name import problem_name as PDF_problem_name
from programs.PDF.user_code.prompt import system_prompt as PDF_system_prompt
from programs.PDF.user_code.prompt import prologue_section as PDF_prologue_section
from programs.PDF.user_code.prompt import epilogue_section as PDF_epilogue_section
from programs.PDF.user_code.evaluation import evaluate as PDF_evaluate
from programs.PDF.user_code.mutation import mutate as PDF_mutate
from programs.PDF.user_code.crossover import crossover as PDF_crossover
...
def IdeaSearch_interface()-> None:
    ...
    program_name = "PDF"
    problem_name = PDF_problem_name
    prologue_section = PDF_prologue_section
    epilogue_section = PDF_epilogue_section
    evaluate_func = PDF_evaluate
...
if __name__ == "__main__":
    ...
    # cleanse_dataset(
    #     database_path = "programs/PDF/dataset/",
    #     evaluate_func = PDF_evaluate,
